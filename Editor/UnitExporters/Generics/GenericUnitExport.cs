...
namespace UnityGLTF.Interactivity.Export
{
    ...
    {
        public GenericInvokeUnitExport(string gltfNodeOp, GenericSocketRules socketRules) : base(gltfNodeOp, typeof(InvokeMember), socketRules)
        {
        }
    }
    ...
    {
        public GenericGetMemberUnitExport(string gltfNodeOp, GenericSocketRules socketRules) : base(gltfNodeOp, typeof(GetMember), socketRules)
        {
        }
    }
    ...
    public abstract class GenericUnitExport : IUnitExporter
    {
        ...
        public GenericUnitExport(string gltfNodeOp, Type unitType, GenericSocketRules socketRules)
        {
            schema = new GltfInteractivityNodeSchema();
            schema.Op = gltfNodeOp;
            ...
            if (!AutoGeneratedSchemata.ContainsKey(schema.Op))
                AutoGeneratedSchemata.Add(schema.Op, schema);
        }

...
namespace Editor.UnitExporters.Lists
{
    public static class ListHelpers
    {
            ...
            ControlInput flowIn, ControlOutput flowOut)
        {
            ...
            var countMinusOne = unitExporter.CreateNode(GenericUnitExport.GetAutoGeneratedSchema("math/sub"));
            ...
            var indexMinusOne = unitExporter.CreateNode(GenericUnitExport.GetAutoGeneratedSchema("math/sub"));
            ...
            ControlInput flowIn, ControlOutput flowOut)
        {
            ...
            var index = unitExporter.CreateNode(GenericUnitExport.GetAutoGeneratedSchema("math/sub"));

...
namespace UnityGLTF.Interactivity.Export
{
    public class LerpClampedUnitExports : IUnitExporter
    {
        ...
        public void InitializeInteractivityNodes(UnitExporter unitExporter)
        {
            ...
            saturateNode.OutValueSocketConnectionData["value"].expectedType = ExpectedType.GtlfType(gltfType);

            GenericUnitExport.TryGetAutoGeneratedSchema("math/mix", out var mixSchema);
            var mixNode = unitExporter.CreateNode(mixSchema);
            mixNode.OutValueSocketConnectionData["value"].expectedType = ExpectedType.GtlfType(gltfType);

...
namespace UnityGLTF.Interactivity.Export
{
    public class RandomRangeUnitExport : IUnitExporter
    {
        ...
        public void InitializeInteractivityNodes(UnitExporter unitExporter)
        {
            ...
            TimeHelpers.AddTickNode(unitExporter, TimeHelpers.GetTimeValueOption.TimeSinceStartup, out var tickNodeValueSocket);
            ...
            mulNode.ValueIn("a").ConnectToSource(tickNodeValueSocket);
            ...
            mixNode.ValueIn("c").ConnectToSource(subNode.FirstValueOut().ExpectedType(ExpectedType.Float)).SetType(TypeRestriction.LimitToFloat);

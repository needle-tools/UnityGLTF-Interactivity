...
namespace UnityGLTF.Interactivity.Export
{
    public class RandomRangeUnitExport : IUnitExporter
    {
        ...
        public void InitializeInteractivityNodes(UnitExporter unitExporter)
        {
            ...
            getVar.OutValueSocketConnectionData["value"].expectedType = ExpectedType.Float;
            ...
            mixNode.InValueSocketConnectionData["a"].typeRestriction = TypeRestriction.LimitToFloat;
            mixNode.InValueSocketConnectionData["b"].typeRestriction = TypeRestriction.LimitToFloat;
            mixNode.OutValueSocketConnectionData["value"].expectedType = ExpectedType.Float;
            
            unitExporter.MapInputPortToSocketName("value", subNode,  "c", mixNode);
